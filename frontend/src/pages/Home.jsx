...
const Home = () => {
  return (
    <>
      <div
        id="home"
        className="h-screen w-screen bg-cover bg-center bg-[url('https://framerusercontent.com/images/SGmk37b8TDX43mcsVuBwFTVon0Y.jpg?scale-down-to=1024')]"
      >
        <div className="h-full w-screen bg-black/70 pt-28 pb-0 flex flex-col justify-start items-center">
          ...
          <span className="h-48 w-full absolute bottom-0 left-0 bg-gradient-to-b from-transparent to-black"></span>
          <RunnigDiv />
        </div>
      </div>
